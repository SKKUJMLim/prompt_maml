...
class MAMLFewShotClassifier(nn.Module):
    def __init__(self, im_shape, device, args):
        ...
        if self.args.prompter and self.args.prompt_engineering == 'arbiter':
            self.arbiter = arbiter.VariationalAutoencoder(input_dim=1600, output_dim=3*84*84, latent_dim=10)
    ...
    def forward(self, data_batch, epoch, use_second_order, use_multi_step_loss_optimization, num_steps, training_phase,
        ...
        for task_id, (x_support_set_task, y_support_set_task, x_target_set_task, y_target_set_task) in \
            ...
            if self.args.prompter and self.args.prompt_engineering == 'arbiter':
                ...
                init_prompt, mu, log_var = self.arbiter(task_embeddings)
            ...
            for num_step in range(num_steps):
                ...
                if use_multi_step_loss_optimization and training_phase and epoch < self.args.multi_step_loss_num_epochs:
                    ...
                    if num_step == (self.args.number_of_training_steps_per_iter - 1):
                        ...
                        task_losses.append(target_loss + kl_loss)
