...
# python train_maml_system.py --name_of_args_json_file experiment_config/MAML+Prompt/per_template/MAML_Prompt_random_patch_5way_5shot_filter128_miniImagenet.json --gpu_to_use 0
# python train_maml_system.py --name_of_args_json_file experiment_config/MAML+Prompt/per_template/MAML_Prompt_fixed_patch_5way_5shot_filter128_miniImagenet.json --gpu_to_use 0
...
## python train_maml_system.py --name_of_args_json_file experiment_config/MAML+Prompt/Resnet12/MAML_Prompt_padding_5way_5shot_Resnet12_FC100.json --gpu_to_use 0
